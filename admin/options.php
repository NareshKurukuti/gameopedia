            ...
            <div class="box">
              ...
              <div class="box-body">
                <table id="example1" class="table table-bordered">
                  ...
                  <tbody>
                    <?php
                    $sql = "SELECT *, options.id AS canid FROM options LEFT JOIN messages ON messages.id=options.message_id ORDER BY messages.priority ASC";
    ...
    function getRow(id) {
      $.ajax({
        ...
        success: function(response) {
          ...
          $('#option_data_edit').val(response.option_data);
          $('#posselect').val(response.message_id).html(response.description);
          $('.optionData').html(response.option_data);
        }
      });
    }
  </script>
